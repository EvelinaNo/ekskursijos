          ...
          excursions.map((excursion) => {
            ...
            return (
              <ExcursionItem key={excursion.registration_id}>
                ...
                <Status isConfirmed={excursion.confirmation}>{excursion.confirmation ? "Confirmed" : "Not confirmed"}</Status>
                <Button onClick={() => cancelRegistration(excursion.registration_id)}>Cancel registration</Button>
                <Button onClick={() => changeRegistrationDate(excursion.registration_id)}>Change date</Button>
              </ExcursionItem>
            );
          })
        )}
